    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='directory_creator', to=settings.AUTH_USER_MODEL)),
                ('moderators', models.ManyToManyField(blank=True, default=None, related_name='page_moderators', to=settings.AUTH_USER_MODEL)),
                ('subscribers', models.ManyToManyField(blank=True, default=None, related_name='page_subscribers', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ('-created',),
            },
